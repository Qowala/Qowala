...
var users = {
    ...
    addUser: function(id) {
        ...
        // Register in MongoDB to be stored on a long-term basis
        usersModel.pushUser(id);
     ...
     */
    setTokens: function(userId, token, tokenSecret){
        var confirmationUser = usersModel.pushUser(userId, token, tokenSecret);
        console.log('Register user with token as : ', confirmationUser);
    },
